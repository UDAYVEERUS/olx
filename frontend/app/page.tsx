    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl mb-0 opacity-90">
            Discover amazing deals from people around you
          </p>

          {/* ✅ Replace the old search bar with SearchBar component */}
          {/* <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-2xl p-2">
